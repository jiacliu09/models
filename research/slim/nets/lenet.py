...
def lenet(images, num_classes=10, is_training=False,
  ...
  with tf.variable_scope(scope, 'LeNet', [images]):
    net = end_points['conv1'] = slim.conv2d(images, 32, [5, 5], scope='conv1') # filter number, filter size, stride =1 
    net = end_points['pool1'] = slim.max_pool2d(net, [2, 2], 2, scope='pool1') # filter size, stride
